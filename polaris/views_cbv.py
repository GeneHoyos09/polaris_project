...
class CargoListView(ListView):
    model = Cargo
    template_name = 'polaris/cbv/cargo_list.html'
...
class CargoCreateView(SuccessMessageMixin, CreateView):
    ...
    template_name = 'polaris/cbv/cargo_form.html'
...
class CargoDeleteView(DeleteView):
    model = Cargo
    template_name = 'polaris/cbv/cargo_confirm_delete.html'
    success_url = reverse_lazy('cbv:cargo_list')
...
class EmpleadoListView(ListView):
    model = Empleado
    template_name = 'polaris/cbv/empleado_list.html'
...
class EmpleadoCreateView(SuccessMessageMixin, CreateView):
    ...
    template_name = 'polaris/cbv/empleado_form.html'
...
class EmpleadoDeleteView(DeleteView):
    model = Empleado
    template_name = 'polaris/cbv/empleado_confirm_delete.html'
    success_url = reverse_lazy('cbv:empleado_list')
